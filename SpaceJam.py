...
class myApp(ShowBase):
    ...
    def SetScene(self, passTrav):
        ...
        self.guard1 = Orbiter(self.loader, self.taskMgr, "Assets/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "Assets/DroneDefender/octotoad1_auv.png", self.oasisPlanet, 900, "MLB", self.player)

        self.guard2 = Orbiter(self.loader, self.taskMgr, "Assets/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "Assets/DroneDefender/octotoad1_auv.png", self.savaPlanet, 500, "Cloud", self.player)

        self.guard3 = Orbiter(self.loader, self.taskMgr, "Assets/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "Assets/DroneDefender/octotoad1_auv.png", self.rockPlanet, 900, "MLB", self.player)

        self.guard4 = Orbiter(self.loader, self.taskMgr, "Assets/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "Assets/DroneDefender/octotoad1_auv.png", self.primePlanet, 500, "Cloud", self.player)
